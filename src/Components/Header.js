...
const Header = ({mainData}) => {
    if(mainData){
        ...
        var interests=mainData.interests;
      ...
      <header id="home">
        <div className="row banner">
           <div className="banner-text">
              ...
              <h3>I'm a <span>{city}</span> based <span>{occupation}</span>. I like {interests}. Shoot me an email at <span>{email}</span> or let's connect on social media.</h3>
              <hr />
              <ul className="social">
                {networks}
              </ul>
